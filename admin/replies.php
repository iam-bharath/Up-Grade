...
$row1 = mysqli_query($con,"SELECT * FROM replies");
?>
<!DOCTYPE html>
<html>
<head>
...
$('#example1').Tabledit({
    ...
    columns: {
        identifier: [0, 'id'],
       editable: [[1, 'title'], [2, 'content'],[3, 'user_id'],[4, 'created_on']]
    },
    onDraw: function() {
        console.log('onDraw()');
    },
 ...
 <div class="panel panel-default">       
  ...
  <div class="jumbotron">
        <table cellpadding="0" cellspacing="0" border="0" id="example1">
            <tr><th>REPLY_Id</th><th>CONTENT</th><th>USER_ID</th><th>TOPIC_ID</th><th>CREATED_ON</th></tr>
