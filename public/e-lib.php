...
<body>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <div style="height:370px;background-color:white">
    <header class="bg-primary py-5 mb-5">
    <div class="container h-70">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12">
          <h1 class="display-4 text-white mt-5 mb-2"><b>HalfWay Down!</b></h1>
          <p class="lead mb-5 text-white "><b>The hardest thing in life is which bridge to cross and which to burn.” - Bertrand Russell</b></p>
        </div>
      </div>
    </div>
  </header>
...
<div class="sidenav">
    <a href="#section1"><b>Ncert</b></a>
    <a href="#section2"><b>Polity</b></a>
    <a href="#section3"><b>Economy</b></a>
...
<div class="row">
  <div class="column">
    <div class="content">
        <a href="ncerthistory.php"><img src="pictures/historymain.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert History(Vi-Xii)</b></h4>
      </div>
  </div>
  ...
  <div class="column">
    <div class="content">
        <a href="ncerthistory.php"><img src="pictures/geographymain.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Geography(Vi-Xii)</b></h4>
      
    </div>
  </div>
  <div class="column">
    <div class="content">
      <a href="ncerthistory.php"><img src="pictures/economics.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Economy(Vi-Xii)</b></h4>
    </div>
  </div>
  <div class="column">
    <div class="content">
   <a href="ncerthistory.php"><img src="pictures/socialsciencemain.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert SocialScience(Vi-Xii)</b></h4>
    </div>
  </div>
    ...
    <div class="column">
    <div class="content">
     <a href="ncerthistory.php"><img src="pictures/artsculture.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Arts,culture(Xi-Xii)</b></h4>
    </div>
  </div>
    ...
    <div class="column">
    <div class="content">
      <a href="ncerthistory.php"><img src="pictures/evsmain.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Evs(Vi-Xii)</b></h4>
    </div>
  </div>
    
    <div class="column">
    <div class="content">
      <a href="ncerthistory.php"><img src="pictures/politicsmain.jpeg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Political Sc(Vi-Xii)</b></h4>
    </div>
  </div>
    
    <div class="column">
    <div class="content">
      <a href="ncerthistory.php"><img src="pictures/sciencemain.jpg" alt="Lights" style="width:100%"></a>
        <h4><b>Ncert Science(Vi-Xii)</b></h4>
    </div>
  </div>
<!-- END GRID -->
        ...
        <div class="content">
 <iframe width="987" height="500" src="https://www.youtube.com/embed/Wr6XmxQSUYA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  <p><i>The above is the reference to ncert history!</i></p>
...
<div class="container">
  <div class="progress">
    ...
    <div class="main">
        <div id="section2">
    <h1><b>Indian Authors!</b></h1>
<hr>
        <p><i>Refer to the video tutorial for extra guidance!</i></p>

<!-- Portfolio Gallery Grid -->
<div class="row">
  <div class="column">
    <div class="content">
      <img src="pictures/polity.jpg" alt="Mountains" style="width:100%">
        <h3><b>Lakshmikanth</b></h3>
      </div>
  </div>
  ...
  <div class="column">
    <div class="content">
   <iframe width="730" height="330" src="https://www.youtube.com/embed/nfqottdezoc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     </div>
  </div>
        </div>
        </div>
  ...
  <div class="column">
    <div class="content">
      <img src="pictures/economy.jpg" alt="Mountains" style="width:100%">
        <h3><b>Ramesh Singh</b></h3>
      </div>
  </div>
           
  <div class="column">
    <div class="content">
   <iframe width="730" height="300" src="https://www.youtube.com/embed/vEMDVYqfq2Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
     </div>
  </div>
        </div>
             </div>
