  ...
  <div class="container" style="  background: #AED6F1  ;">
     <div class="jumbotron ">    
        ...
        <div id="section5">
          ...
          <h1>Do we need a countrywide National Register of Citizens?</h1></div>
            <img src="./pictures/nrc1.jpg" height="350" width="350" alt="Editorial">
<!--  <p></p>            -->
  <table class="table">
    <thead>
      <tr>
          ...
          <th><h4>Context</h4></th>
          <th><h4>In Brief</h4></th>
      </tr>
    </thead>
    <tbody>
      <tr>
          <td><b>Mains Paper 2: </b> <i> Polity</i> <br>

              <b>Prelims level: </b>  <i>NRC</i> <br><b>
              Mains level:</b> <i> Arguments behind NRC and implementation process</i>
 </td>
        <td>
  <h3>Context</h3>
          <p>• After rolling out the National Register of Citizens(NRC) in Assam, the incumbent government at the Centre has said it will conduct a similar exercise in the rest of the country.</p>
            
          <h3>History of NRC</h3>
          <p>• In 1971, Bangladesh gained independence from Pakistan. The liberation war led to a massive influx of migrants to India until 1983.
...
• This Act was applicable to only Assam, while the Foreigners Act, 1946 was applicable to all other states. Thus NRC is an Assam specific exercise and it is opined that there is no need for a nationwide NRC.</p>

         <h3>Key issues</h3>
          <p>• It is alleged that the all India NRC is based on majoritarian sentiments built on the misery of minorities.

• The government claims extending NRC to other states as an exercise to get rid of illegal migrants, protect interests of the minorities and better utilisation of resources which has not been accepted by many experts considering the fate of 1.9 crore people excluded from it.</p>
            
            
            <h3>Conclusion</h3>
          <p>• Thus it is opined that a nationwide NRC will only be problematic and should be avoided.</p>
            
            
        <h3>Prelims Questions:</h3>
          <p> Consider following statements regarding ‘Index of Industrial Production (IIP)’-<br>

1. It has its base 2011-12 <br>

2. Index number for the base year is to be taken as 100, and that for all subsequent periods are the percentages of the value for the base period <br>
...
Answer: C</p>    
     ...
     <h3>Mains Questions:</h3>
          <p>Q.1)  Do we need a countrywide National Register of Citizens? Give your arguments in this regard</p>      </td>
  ...
  <div class="jumbotron ">    
        ...
        <div id="section5">
          ...
          <h1>What PMC means?</h1></div>
        <img src="./pictures/pmc.jpg" height="350" width="350" alt="Editorial">
<!--  <p></p>            -->
  <table class="table">
    <thead>
      <tr>
    ...
    <tbody>
      <tr>
          ...
          <td><b>Mains Paper 3:</b> <i> Economy</i> <br>

              <b>Prelims level:</b>  <i> PMC Bank crisis</i> <br><b>
              Mains level:</b> <i> Regulatory functions of the RBI</i>
 </td>
        <td>
  <h3>Context</h3>
          <p>• In at least three of the major financial sector scams in the last couple of months in India, featuring Punjab National Bank, IL and FS, some private banks and now the latest, Punjab and Maharashtra Cooperative Bank or PMC, apart from poor governance and fraudulent practices, a common thread has been supervisory failure.</p>
            
          <h3>Supervision authority</h3>
          <p>• The country’s leading financial sector regulator, the RBI, has been shown as flat-footed, responding only after the event.

• Like IL and FS, in the PMC case too, there appears to be culpability on the part of the management and the board of the bank.
...
• The limitations in superceding the board of directors or removing directors of these banks, unlike in commercial banks.</p>

         <h3>Conclusion</h3>
          <p>• Carving out a separate authority for supervision may only lead to regulators working in silos.

• With a weakening economy, the last thing India needs is the unravelling of more such firms stoking fears of financial instability.</p>
            
            
        <h3>Prelims Questions:</h3>
          <p>Q.1) Consider following statements regarding Prime Minister’s Employment Generation Programme (PMEGP)- <br>

1. The scheme is implemented by Khadi and Village Industries Commission (KVIC) functioning as the nodal agency at the national level. <br>

2. Any individual, above 18 years of age can apply. <br>
...
Answer: C</p>    
     ...
     <h3>Mains Questions:</h3>
          <p>Q.1) What is the PMC crisis? Discuss the role of credit delivery abilities performed by the co-operative banks? How RBI can restructured their regulatory functions to address issues like this?</p>      </td>
      ...
      <div class="jumbotron">    
        ...
        <div id="section5">
          ...
          <h1> THE MINIMUM WAGE SOLUTION !</h1></div>
          <div>
          <img src="./pictures/editorial-4.jpg" height="400" width="400" alt="Editorial">
          </div>
  ...
  <table class="table">
    ...
    <tbody>
      <tr>
        ...
        <td>
  <h3>Context</h3>
          <p>• The government made two recent announcements at two ends of the spectrum to mitigate the economic crisis.<br>

•One concerns a new indexation of NREGA wages meant to increase rural incomes. The second is a reduction in corporate tax rate.<br>

•A committee of experts set up by the Union rural development ministry has recommended that the wages paid to unskilled agricultural labourers under the Mahatma Gandhi National Rural Employment Guarantee Act (MGNREGA) should be the minimum wage fixed by the respective state or the current wage as per the consumer price index for agricultural labourers (CPI-AL), whichever is higher.<br>

•The panel also recommended linking the wages to the Consumer Price Index, Rural (CPI-R), for protecting MGNREGA wages against inflation.</p>
            
          <h3>Mahatma Gandhi National Rural Employment Guarantee Act (MGNREGA) of 2005</h3>
          <p>• This is a rural wage employment programme in India. It provides for a legal guarantee of at least 100 days increased to 150 days now, of unskilled wage employment in a financial year to rural households whose adult members are willing to engage in unskilled manual work at a pre-determined minimum wage rate.<br><br>
              
              <b>The objectives of the Act are:</b><br>

• to enhance the livelihood security of the rural poor by generating wage employment opportunities; and<br>

• to create a rural asset base which would enhance productive ways of employment, augment and sustain rural household income.</p><br>
...
1.Minimum wages are neither a dole nor an act of charity. They are a legal mandate that are arrived at by calculating the minimal nutritional requirement and basic needs of an individual.<br>

2. The issue of wages has been another issue that needs attention till now. There is a wide spread corruption while disbursing wages.<br>

Problems like fake bank accounts, offering fewer wages, delayed wages etc. This needs to be addressed properly for effective implementation of the Act.<br>              
